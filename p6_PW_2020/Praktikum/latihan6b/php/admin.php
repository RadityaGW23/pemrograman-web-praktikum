    ...
    <table border="1" cellpadding="13" cellsapcing="0">
        ...
        <?php foreach($pakaian as $apparel) : ?>
            <tr>
                <td><?= $i; ?></td>
                <td>
                    <div class="update"><a href=""><Ubah type="button" class="btn btn-primary btn-sm">Ubah</button></a></div>
                    <div class="delete"><a href=""><button type="button" class="btn btn-primary btn-sm">Hapus</button></a></div>
                </td>
